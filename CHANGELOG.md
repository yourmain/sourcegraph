...
- The campaigns feature (in beta) is now enabled by default for all users. It can be disabled by setting `campaigns.enabled` to `false` in the site configuration.
